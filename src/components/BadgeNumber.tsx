...
import type { BadgeState, BadgeVariant } from "./Badge";
...
export function BadgeNumber({
  ...
  const shell =
    "inline-flex h-5 min-h-5 min-w-5 shrink-0 items-center justify-center gap-0 rounded-full border px-[var(--spacing-1)] font-body text-xs font-semibold leading-4 tabular-nums outline-none transition-[background-color,background-image,box-shadow,color,border-color,opacity]";
